...
typedef struct {
  ...
  __DECLARE_EXTERNAL(INT,DISTANCE)
  __DECLARE_EXTERNAL(BOOL,DISTANCE_READY)
  ...
  __DECLARE_VAR(INT,_TMP_MOVE24_OUT)
  ...
  __DECLARE_VAR(BOOL,_TMP_GE4_ENO)
  __DECLARE_VAR(BOOL,_TMP_GE4_OUT)
