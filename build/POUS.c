...
static inline INT __WATERESP_MOVE__INT__INT1(BOOL EN,
  INT IN,
  WATERESP *data__)
{
  INT __res;
...
static inline BOOL __WATERESP_GE__BOOL__INT3(BOOL EN,
  UINT __PARAM_COUNT,
  INT IN1,
  INT IN2,
  WATERESP *data__)
{
  BOOL __res;
  BOOL __TMP_ENO = __GET_VAR(data__->_TMP_GE4_ENO,);
  __res = GE__BOOL__INT(EN,
    &__TMP_ENO,
    __PARAM_COUNT,
    IN1,
    IN2);
  __SET_VAR(,data__->_TMP_GE4_ENO,,__TMP_ENO);
  return __res;
}

static inline BOOL __WATERESP_LT__BOOL__INT4(BOOL EN,
  UINT __PARAM_COUNT,
  INT IN1,
  INT IN2,
  WATERESP *data__)
...
void WATERESP_init__(WATERESP *data__, BOOL retain) {
  __INIT_EXTERNAL(INT,DISTANCE,data__->DISTANCE,retain)
  __INIT_EXTERNAL(BOOL,DISTANCE_READY,data__->DISTANCE_READY,retain)
  ...
  __INIT_VAR(data__->_TMP_GE4_ENO,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->_TMP_GE4_OUT,__BOOL_LITERAL(FALSE),retain)
...
void WATERESP_body__(WATERESP *data__) {
  ...
  __SET_VAR(data__->,_TMP_MOVE24_OUT,,__WATERESP_MOVE__INT__INT1(
    (BOOL)__BOOL_LITERAL(TRUE),
    (INT)__GET_EXTERNAL(data__->DISTANCE,),
    data__));
  if (__GET_VAR(data__->_TMP_MOVE24_ENO,)) {
    __SET_VAR(data__->,CURRENTDISTANCE,,__GET_VAR(data__->_TMP_MOVE24_OUT,));
  };
  ...
  __SET_VAR(data__->,_TMP_GE4_OUT,,__WATERESP_GE__BOOL__INT3(
    (BOOL)__BOOL_LITERAL(TRUE),
    (UINT)2,
    (INT)__GET_VAR(data__->CURRENTDISTANCE,),
    (INT)__GET_VAR(data__->EMPR_THRESHOLD,),
    data__));
  __SET_VAR(data__->,EMPR_LED,,__GET_VAR(data__->_TMP_GE4_OUT,));
  __SET_VAR(data__->,_TMP_LT7_OUT,,__WATERESP_LT__BOOL__INT4(
    (BOOL)__BOOL_LITERAL(TRUE),
    (UINT)2,
    (INT)__GET_VAR(data__->CURRENTDISTANCE,),
    (INT)__GET_VAR(data__->FULLG_THRESHOLD,),
