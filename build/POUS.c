...
void WATERESP_init__(WATERESP *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->COUNTER_ENABLE,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->COUNTER_RESET,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->COUNTER_Q,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->COUNTER_MAX,10,retain)
...
void WATERESP_body__(WATERESP *data__) {
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,(__GET_VAR(data__->PULSE,) && __GET_VAR(data__->COUNTER_ENABLE,)));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->CTU0.,EN,,__BOOL_LITERAL(TRUE));
  __SET_VAR(data__->CTU0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
  __SET_VAR(data__->CTU0.,R,,(__GET_VAR(data__->COUNTER_Q,) || __GET_VAR(data__->COUNTER_RESET,)));
  __SET_VAR(data__->CTU0.,PV,,__GET_VAR(data__->COUNTER_MAX,));
  CTU_body__(&data__->CTU0);
  if (__GET_VAR(data__->CTU0.ENO,)) {
    __SET_VAR(data__->,COUNTER_VALUE,,__GET_VAR(data__->CTU0.CV,));
  };
  __SET_VAR(data__->,COUNTER_Q,,__GET_VAR(data__->CTU0.Q,));
